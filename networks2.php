...
<head>
    <meta charset="utf-8">
   <meta name="Description" content="الشروق للبرمجيات هو موقع متخصص في الإنتاج Network Apps والتطبيقات المكتب والتطبيقات الويب والتطبيقات الموبايل والتطبيقات التطبيقات السحابية والمواقع الإلكترونية المحترفة بالإضافة الى الدورات العلمية البرمجة والقواعد البيانات ">
  <meta name="Keywords" content=
"البرمجة Network Apps,البرمجة التطبيقات المكتب,البرمجة التطبيقات الويب,البرمجة التطبيقات الموبايل,البرمجة التطبيقات السحابية, البرمجة المواقع الإلكترونية,التدريس الدورات البرمجة,التدريس الدورات القواعد البيانات">
...
<table id="myTable" Border="1" id="customers"  style="font-family:Jomhuria;font-size:100%;">
  <tr class="header">
   <th style="width:3%;">No</th>
    <th style="width:28%;">App Arabic Name </th>
     <th style="width:40%;">App English Name </th>
    <th style="width:14%;">App Type</th>
