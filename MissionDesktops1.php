        ...
        <div class="row">
            <div id="banner" class="container-fluid col-xs-12">
                <div id="banner-img" style="background-image:url(images/banner-blog.jpg">
                    <div class="overlay">
                        <h2 class="title1">Misstion One </h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="text-center">
                        ...
                        <p class="custom-paragraph" style="color:black;font-size:30px;font-family:Amiri;">
                            ...
                            My first mission is production high quality desktop applications
                            for private and public institutions in our country
                            (Somaliland) for educational, commercial and
                            governmental purposes as well as production courses in the field of programming and databases for desktop applications for students, schools, institutes and universities
                            And production of programming books and databases for desktop applications
